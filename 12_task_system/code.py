import json, os, subprocess, time, re, random
...
#     """打印完整的 messages 原始结构（JSON 格式）"""
#     print("\n" + "=" * 60)
#     print("📜 完整对话历史 (JSON)")
#     print("=" * 60)

#     def serialize(obj):
#         """递归处理 Anthropic 对象 → 纯 dict，确保可 JSON 化"""
...
#     print(json.dumps(serialize(history), indent=2, ensure_ascii=False))
#     print("=" * 60 + "\n")
